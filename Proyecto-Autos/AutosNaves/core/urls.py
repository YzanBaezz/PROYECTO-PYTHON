...
from .views import home, CHEVROLET, FORD, HYUNDAI, JEEP, mapa, Marcas, admin, AgregarAutos, Autos, Camionetas,InicioSesion, RegistroSesion, PerfilUsuario, AtencionCliente, EditarPerfil, Catalogo, Auto, login, registro, logout
